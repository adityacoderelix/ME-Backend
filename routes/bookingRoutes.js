...
router.post("/updateStatus", bookingController.markBookingAsPaid);
...
// Cancel a booking
router.patch("/host/cancel", bookingController.cancelBooking);

// Confirm a booking (host action)
router.patch("/host/confirm", bookingController.confirmBooking);
